...
if __name__ == '__main__':
    ...
    parser.add_option('-t', '--test', dest='do_test', default=False,
                      help='Run the testing', metavar='DO_TEST',
                      action='store_true')
    ...
    parser.add_option('-d', '--load_params', dest='start_with_saved_params',
    ...
    if not options.do_learn and not options.do_test:
        print("\nMust specify at least either learn or test:\n\n")
        print(__doc__)
