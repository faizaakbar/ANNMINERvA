...
Execution:
    python minerva_triamese_inception.py -h / --help
...
from minerva_ann_networks import build_triamese_inception
...
if __name__ == '__main__':
    ...
    parser.add_option('-s', '--save_file', dest='save_model_file',
                      default='./lminervatriamese_inception.npz',
    ...
    build_network_function = build_triamese_inception
