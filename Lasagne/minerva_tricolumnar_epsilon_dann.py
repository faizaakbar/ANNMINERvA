...
where pulse-height and time tensors are bundled.

Execution:
    python minerva_tricolmnar_spacetime_epsilon.py -h / --help
...
from minerva_ann_networks import build_dann_xview_epsilon
from minerva_ann_operate_networks import categorical_learn_and_validate_dann
...
if __name__ == '__main__':
    ...
    import logging
    logfilename = options.logfilename or 'minerva_tricolumnar_epsilon_dann.log'
    logging.basicConfig(
    ...
    build_network_function = build_dann_xview_epsilon
    learn = categorical_learn_and_validate_dann
    ...
    if options.do_learn:
        ...
        networkstr['input_list_target'] = get_theano_input_tensors()
