...
Execution:
    python minerva_triamese_delta.py -h / --help
...
from minerva_ann_networks import build_triamese_delta
...
if __name__ == '__main__':
    ...
    parser.add_option('-s', '--save_file', dest='save_model_file',
                      default='./lminervatriamese_betaprime.npz',
    ...
    parser.add_option('--target_idx', dest='target_idx', default=4,
                      help='Target index', metavar='TGT_IDX', type='int')
    ...
    build_network_function = build_triamese_delta
