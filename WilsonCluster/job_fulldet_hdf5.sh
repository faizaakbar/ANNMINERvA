...
OUTBASE="${OUTPATH}/minosmatch_nukecczdefs_genallzwitht_pcodecap66_127x94x47_xuv_${SAMPLE}"

# time-lattice images
INBASET="${INPATH}/minosmatch_nukecczdefs_fullzwitht_tproc_127x94_${SAMPLE}"
OUTBASET="${OUTPATH}/minosmatch_nukecczdefs_genallzwitht_pcodecap66_127x94x47_txtutv_${SAMPLE}"
