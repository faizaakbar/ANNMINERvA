...
SAVEMODELNAME="./lminerva_time_epsilon${DATET}.npz"
PYTHONPROG="minerva_tricolumnar_time_epsilon.py"
...
LOGFILENAME=minerva_tricolumnar_time_epsilon_${DATET}_${GIT_VERSION}.log
