...
IMGX=72
IMGUV=36
DATAFILENAME="/phihome/perdue/theano/data/minosmatch_singlepi0_tracker_127x${IMGX}x${IMGUV}_xuv_me1Amc.hdf5"
SAVEMODELNAME="./lminerva_singlepi0_epsilon`date +%s`.npz"
PYTHONPROG="minerva_singlepi0_epsilon.py"
